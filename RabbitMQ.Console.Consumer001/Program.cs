...
namespace RabbitMQ.Console.Consumer001
{
    class Program
    {
            ...
            using (var connection = factory.CreateConnection())
            {
                using (var channel = connection.CreateModel())
                {
                    ...
                    consumer.Received += (model, ea) =>
                    {
                        ...
                        if (helloMessage.Criteria.Equals("Consumer001") || DateTime.Now < helloMessage.EventDate.AddSeconds(helloMessage.DelaySeconds))
                        {
                    ...
                    channel.BasicConsume(
                        queue: "hello",
                        autoAck: false,
                        consumerTag: "consumer001",
                        consumer: consumer
                    );

                    System.Console.WriteLine(" Consumer001 - Press [enter] to exit.");
